  ...
  return (
    <section className="space-y-24 relative w-full overflow-x-hidden" style={{ overflowY: 'visible', maxHeight: 'none' }}>
      ...
      <div className="grid md:grid-cols-4 gap-6 relative z-10 w-full max-w-full" style={{ overflowY: 'visible', maxHeight: 'none' }}>
        <ScrollReveal direction="up" delay={100} style={{ height: '100%', display: 'flex' }}>
          <InteractiveCard className="group border border-gray-300 dark:border-gray-700 p-6 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 hover:shadow-lg bg-white/50 dark:bg-black/50 backdrop-blur-sm flex flex-col w-full" style={{ height: '100%', minHeight: 0 }}>
        ...
        <ScrollReveal direction="up" delay={200} style={{ height: '100%', display: 'flex' }}>
          <InteractiveCard className="group border border-gray-300 dark:border-gray-700 p-6 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 hover:shadow-lg bg-white/50 dark:bg-black/50 backdrop-blur-sm flex flex-col w-full" style={{ height: '100%', minHeight: 0 }}>
            <div className="w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 mb-4 flex items-center justify-center group-hover:bg-blue-500 dark:group-hover:bg-blue-500 transition-colors flex-shrink-0">
              <svg className="w-6 h-6 text-blue-600 dark:text-blue-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ScrollReveal direction="up" delay={300} style={{ height: '100%', display: 'flex' }}>
          <InteractiveCard className="group border border-gray-300 dark:border-gray-700 p-6 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 hover:shadow-lg bg-white/50 dark:bg-black/50 backdrop-blur-sm flex flex-col w-full" style={{ height: '100%', minHeight: 0 }}>
            <div className="w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 mb-4 flex items-center justify-center group-hover:bg-blue-500 dark:group-hover:bg-blue-500 transition-colors flex-shrink-0">
              <svg className="w-6 h-6 text-blue-600 dark:text-blue-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <ScrollReveal direction="up" delay={400} style={{ height: '100%', display: 'flex' }}>
          <InteractiveCard className="group border border-gray-300 dark:border-gray-700 p-6 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 hover:shadow-lg bg-white/50 dark:bg-black/50 backdrop-blur-sm flex flex-col w-full" style={{ height: '100%', minHeight: 0 }}>
            <div className="w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 mb-4 flex items-center justify-center group-hover:bg-blue-500 dark:group-hover:bg-blue-500 transition-colors flex-shrink-0">
              <svg className="w-6 h-6 text-blue-600 dark:text-blue-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
